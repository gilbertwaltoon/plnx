...
#
# create_vivado_project.tcl: Tcl script for re-creating project 'coraz7'
#
# Generated by Vivado on Sat Jan 06 15:56:36 GMT 2024
...
#
#    "/home/harry/Petalinux/plnx_projects/vivado/bd/bd1/bd1.bd"
#    "/home/harry/Petalinux/plnx_projects/vivado/bd/bd1/hdl/bd1_wrapper.vhd"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/bd/bd1/bd1.bd"]"\
 "[file normalize "$origin_dir/bd/bd1/hdl/bd1_wrapper.vhd"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/coraz7"]"
...
set file "$origin_dir/bd/bd1/bd1.bd"
...
set file "$origin_dir/bd/bd1/hdl/bd1_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property -name "top" -value "bd1_wrapper" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/coraz7.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/coraz7.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/coraz7.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
